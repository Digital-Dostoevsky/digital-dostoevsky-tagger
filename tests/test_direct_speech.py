...
def test_emdash_complex():
    """
    From: `Бесы-У Тихона - Proofed.txt`
    """
    source = "— Вы меня знаете? — спросил он вдруг отрывисто, — рекомендовался я вам или нет, когда вошел? Я так рассеян..."
    expected = "<said>Вы меня знаете?</said> <said>спросил он вдруг отрывисто</said>, <said>рекомендовался я вам или нет, когда вошел? Я так рассеян...</said>"
