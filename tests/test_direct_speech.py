...
examples = [
    ...
    (
        ...
        """,
        """
        — <said>И не в чем мне у вас прощения просить</said>, — продолжал он, как бы совсем не замечая моих криков, — <said>потому вы же обозвали меня <said>«палачом»</said></said>, на чем я с вас могу в квартале всегда за обиду просить.
